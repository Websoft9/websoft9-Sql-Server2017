...
SqlServer installation directory:  */data/sqlserver*  
SqlServer logs directory:  */data/logs/sqlserver*  
...
| --- | --- | --- | --- |
| HTTP | 8161 | HTTP requests for SqlServer Console| Required |
...
# SqlServer version
sqlserverctl status | grep SqlServer*
```
