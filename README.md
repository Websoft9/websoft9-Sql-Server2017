...
更多请见 [官方 System requirement](https://www.sqlserver.com/download.html)
...
我们会定期检查版本准确性，并测试此项目，以保证用户可以顺利安装所需的SqlServer版本。  
...
```
wget -N https://raw.githubusercontent.com/Websoft9/ansible-linux/master/scripts/install.sh; bash install.sh -r sqlserver
```
...
多种原因导致无法顺利安装，请使用我们在公有云上发布的 [SqlServer 镜像](https://apps.websoft9.com/sqlserver) 的部署方式


## 文档

文档链接：https://support.websoft9.com/docs/sqlserver/zh
